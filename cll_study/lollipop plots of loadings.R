  fabload = data.frame(benchmark_res_fabcut$FABIA$loadings)
  fabload$feature = rownames(fabload)
  # clean the datasets
  #fabload$feature <- gsub("^(methyl|drugs)::", "", fabload$feature)
  ...
  plot(fabload_split_fab$drugs$F1)
  plot(fabload_split_fab$methyl$F1)
  ...
  # Drugs – Factor 1
  p_drugs_F1 <- plot_factor_loadings_gg(
    fabload_split_fab$drugs,
    feature_col = "feature",
    loading_col = "F1",
    top_n = 10,
  ...
  # Methylation – Factor 1
  p_methyl_F1 <- plot_factor_loadings_gg(
    fabload_split_fab$methyl,
    feature_col = "feature",
    loading_col = "F1",
    top_n = 10,
    title = "" # FABIA loadings (Methylation) – Factor 1
  )
  p_methyl_F1
